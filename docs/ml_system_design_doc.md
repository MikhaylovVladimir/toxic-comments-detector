...
Цель пилотного запуска — проверить применимость модели детекции токсичных комментариев в условиях, приближенных к реальным, и оценить её качество и стабильность до полноценного внедрения.
